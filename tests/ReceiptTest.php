...
class ReceiptTest extends TestCase{
    ...
    public function testSubtotal($items, $expected){
        ...
        $this->assertEquals($expected,$output,"should eq {$expected}");
    }
...
//        $this->assertEquals(1.00,$output,'The tax calc should qe 1.00');
//    }
...
//            ->getMock();
//        $Receipt->expects($this->once())->method('subtotal')
//            ->with($items,$coupon)
//            ->will($this->returnValue(10.00));
//        $Receipt->expects($this->once())->method('tax')
//            ->with(10.00)
//            ->will($this->returnValue(1.00));
    ...
    public function testSubtotalAndCoupon(){
        ...
        $this->assertEquals(12,$output,'should eq 12');
    }
